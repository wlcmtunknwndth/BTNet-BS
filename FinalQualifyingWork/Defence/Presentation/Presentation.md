...
style: |
  ...
  section.evidence td { background: var(--paper); }
  .final-grid {
    display: grid;
...
<div class="box choice">держать опцион <strong>или</strong> исполнить его сейчас</div>
...
<div class="note">BTNetAmerican использует малую глубину `n = 9`; QuantLib CRR(500) взят как более дорогой численный ориентир.</div>
...
- обе ошибки малы относительно CRR(500)
- European → American не дал устойчивого преимущества
- аналитическая CRR-инициализация точнее в базовом сценарии
...
**Основные выводы:** при малой глубине `n = 9` модель дает близкую цену к CRR(500), перенос весов не дал устойчивого преимущества, а Gamma требует гладкой модификации архитектуры.
